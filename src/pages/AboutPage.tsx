...
const accordionItems = [
  {
    ...
    body:
      "Every residence is curated with materials, trades, and finishes that age beautifully and perform for decades.",
  },
  {
    title: "View-First Site Planning",
    body:
      "We position every home to maximize light, landscape, and privacy — with outdoor living at the center.",
  },
  {
    title: "Lifestyle-Ready Amenities",
    body:
      "From wellness and entertaining to flexible workspaces, every plan is designed for how you live today.",
  },
  {
    title: "Enduring Value",
    body:
      "We focus on timeless design, premium locations, and low-maintenance materials that protect long-term value.",
  },
];
    ...
    <>
      ...
      <section className="section">
        ...
        <div className="hero-media">
          <img className="hero-img" alt="Real Gold Properties" src={heroImage} />
        </div>
      </section>
          ...
          <div className="two-col">
            <div className="copy stack">
              ...
              <p className="copy-secondary">
                We collaborate with leading architects, landscape designers, and
                artisans to deliver residences that feel curated, not
                constructed.
              </p>
            </div>
            <div>
              <img className="img" alt="Luxury pool" src={img("ps1 (2).jpg")} />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="two-col two-col-center">
            <div className="copy stack">
              ...
              <p>
                ...
                connection. Our communities are designed to feel both exclusive
                and welcoming — a place to belong.
              </p>
            </div>
      ...
      <section className="section section-mid">
        <div className="container">
          <div className="two-col two-col-start">
            ...
            <div>
              <img className="img" alt="Coastal terrace" src={img("ps1 (4).jpg")} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="img-overlay">
        ...
        <div className="overlay-card">
          <div className="mark" style={{ justifyContent: "flex-start", margin: "0 0 18px 0" }}>
            <div className="twrap" style={{ alignItems: "flex-start" }}>
              <div className="t2" style={{ color: "var(--green)", opacity: 0.75 }}>
